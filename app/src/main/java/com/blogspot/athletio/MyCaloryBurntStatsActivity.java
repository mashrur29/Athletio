...
public class MyCaloryBurntStatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initHaspMap();
        hashMap = myProgressValues.caloryBurntProgressHashMap;
        setContentView(R.layout.activity_my_calory_burnt_stats);
        lineChart = (LineChart) findViewById(R.id.my_calory_burnt_progress_chart);
    ...
    void initHaspMap() {
        ...
        if (sharedPrefData.getSaved()) {
            ...
            myProgressValues.caloryBurntProgressHashMap = user.getUserData().getCalorieMap();
        }
    }
