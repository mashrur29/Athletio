...
public class MyStepCountProgressStatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // initHaspMap();
        hashMap = myProgressValues.stepCountProgressHashMap;
        setContentView(R.layout.activity_my_step_count_progress_stats);
        lineChart = (LineChart) findViewById(R.id.my_step_count_progress_chart);
    ...
    void initHaspMap() {
        ...
        if (sharedPrefData.getSaved()) {
            ...
            myProgressValues.stepCountProgressHashMap = user.getUserData().getStepCountMap();
        }
    }
