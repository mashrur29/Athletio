...
public class SharedPrefData {
    ...
    public void clear() {
        ...
        SharedPreferences langSaved = context.getSharedPreferences(LANGUAGE, MODE_PRIVATE);
        SharedPreferences.Editor editorLang = langSaved.edit();
        editorSaved.putInt(LANGUAGE, SharedPrefData.ENGLISH);
        editorSaved.commit();
    }


    //Returns the language saved
    public int getLanguage() {
        SharedPreferences prefSaved = context.getSharedPreferences(LANGUAGE, MODE_PRIVATE);
        return prefSaved.getInt(LANGUAGE, 0);
    }
